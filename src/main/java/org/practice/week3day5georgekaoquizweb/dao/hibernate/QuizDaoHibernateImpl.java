...
import org.practice.week3day5georgekaoquizweb.domain.hibernate.*;
...
public class QuizDaoHibernateImpl implements QuizDao {
    ...
    public List<HistoryQuizJoin> getAllHistoryQuizByUserId(int user_id){
        ...
        String hql = "SELECT new org.practice.week3day5georgekaoquizweb.domain.hibernate.HistoryQuizJoinHibernate(" +
